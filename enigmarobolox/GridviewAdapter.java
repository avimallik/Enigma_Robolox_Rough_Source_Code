...
/**
 * Created by Arm_AVI on 4/4/2018.
 */
...
public class GridviewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        {
            view = new ViewHolder();
            convertView = inflator.inflate(R.layout.gridviewmodel, null);
            view.txtViewTitle = (TextView) convertView.findViewById(R.id.txtViewTitle);
